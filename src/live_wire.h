...
typedef enum {
    ...
    UM_WIRE_IP_ACK = 18,
    UM_WIRE_PROXY_TURN = 19,
    UM_WIRE_PROXY_TURN_ACK = 20,
    UM_WIRE_PROXY_TURN_COMMIT = 21,
    UM_WIRE_PROXY_COMPLETE = 22,
    UM_WIRE_CALIB_BODY_PROBE = 23,
    UM_WIRE_CALIB_BODY_RESULT = 24,
    UM_WIRE_IP_WINDOW = 25
} um_live_wire_type;
